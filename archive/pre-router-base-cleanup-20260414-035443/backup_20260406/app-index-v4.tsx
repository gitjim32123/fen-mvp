...
const VineGrowth = ({ growth }: { growth: Animated.Value }) => {
  ...
  const outerOp = growth.interpolate({
    inputRange: [0, 0.01],
    outputRange: [0, 1],
  }) as any;

  const midOp = growth.interpolate({
    inputRange: [0, 0.5, 0.85],
    outputRange: [0, 0, 1],
  }) as any;

  const innerOp = growth.interpolate({
    inputRange: [0, 0.7, 1],
    outputRange: [0, 0, 1],
  }) as any;
  ...
  return (
    <Svg width={VIEW_W} height={VIEW_H} viewBox={`0 0 ${VIEW_W} ${VIEW_H}`}>
      ...
      <Animated.View style={{ opacity: outerOp }}>
        <Svg width={VIEW_W} height={VIEW_H} viewBox={`0 0 ${VIEW_W} ${VIEW_H}`}>
          <AP
            d={VINE_PATH}
            fill="none"
      ...
      <Animated.View style={{ opacity: midOp }}>
        <Svg width={VIEW_W} height={VIEW_H} viewBox={`0 0 ${VIEW_W} ${VIEW_H}`}>
          <AP
            d={VINE_PATH}
            fill="none"
      ...
      <Animated.View style={{ opacity: innerOp }}>
        <Svg width={VIEW_W} height={VIEW_H} viewBox={`0 0 ${VIEW_W} ${VIEW_H}`}>
          <AP
            d={VINE_PATH}
            fill="none"
