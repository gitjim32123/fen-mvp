...
const VineGrowth = ({ growth }: { growth: Animated.Value }) => {
  ...
  const o1 = growth.interpolate({ inputRange: [0, 0.01], outputRange: [0, 1] }) as any;
  const o2 = growth.interpolate({ inputRange: [0, 0.5, 0.85], outputRange: [0, 0, 1] }) as any;
  const o3 = growth.interpolate({ inputRange: [0, 0.7, 1], outputRange: [0, 0, 1] }) as any;

  return (
    <Svg width={VW} height={VH} viewBox={`0 0 ${VW} ${VH}`}>
      <Defs>
        <LinearGradient id="g0" x1="0" y1="1" x2="0" y2="0">
      ...
      <AP d={VINE} fill="none" stroke="url(#g0)" strokeWidth={14} strokeLinecap="round" strokeLinejoin="round" strokeDasharray={PDASH} strokeDashoffset={off} />
      <AnimatedPath d={VINE} fill="none" stroke="url(#g1)" strokeWidth={9} strokeLinecap="round" strokeLinejoin="round" strokeDasharray={PDASH} strokeDashoffset={off} opacity={o2} />
      <AnimatedPath d={VINE} fill="none" stroke="url(#g2)" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" strokeDasharray={PDASH} strokeDashoffset={off} opacity={o3} />
      <AnimatedPath d={VINE} fill="none" stroke="#5ab070" strokeWidth={1} strokeLinecap="round" strokeLinejoin="round" strokeDasharray={PDASH} strokeDashoffset={off} opacity={o1} />
    </Svg>
  );
};
...
export default function IntroScreen() {
  ...
  useEffect(() => {
    ...
    Animated.timing(growth, { toValue: 1, duration: 2000, delay: 500, easing: EASE_OUT, useNativeDriver: false }).start();
    ...
    Animated.sequence([
      ...
      Animated.parallel([
        Animated.timing(vineOut, { toValue: 0, duration: 600, easing: EASE, useNativeDriver: true }),
        Animated.timing(logoIn, { toValue: 1, duration: 600, easing: EASE, useNativeDriver: true }),
      ]),
      ...
      Animated.delay(700),
      Animated.parallel([
        Animated.timing(fL, { toValue: 0, duration: 250, easing: EASE, useNativeDriver: true }),
        Animated.timing(fW, { toValue: 0, duration: 250, easing: EASE, useNativeDriver: true }),
      ]),
      Animated.delay(200),
      ...
      Animated.delay(700),
      Animated.parallel([
        Animated.timing(eL, { toValue: 0, duration: 250, easing: EASE, useNativeDriver: true }),
        Animated.timing(eW, { toValue: 0, duration: 250, easing: EASE, useNativeDriver: true }),
      ]),
      Animated.delay(200),
      ...
      Animated.delay(700),
      Animated.parallel([
        Animated.timing(nL, { toValue: 0, duration: 250, easing: EASE, useNativeDriver: true }),
        Animated.timing(nW, { toValue: 0, duration: 250, easing: EASE, useNativeDriver: true }),
      ]),
      Animated.delay(250),
