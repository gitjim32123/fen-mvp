...
const BLOCKED_JOB_TYPES: { pattern: RegExp; label: string }[] = [
  ...
  { pattern: /\b(carpenter|joiner|joinery|bricklayer|bricklaying|plasterer|plastering|tiler|tiling)\b/i, label: "Trade work is not suitable for FEN MVP." },
  { pattern: /\b(decorator|painter and decorator|flooring installer|kitchen fitter|bathroom fitter|window fitter)\b/i, label: "Trade work is not suitable for FEN MVP." },
  { pattern: /\b(fencing contractor|driveway contractor|groundworks|demolition|scaffolding|hvac|air conditioning installer)\b/i, label: "Trade work is not suitable for FEN MVP." },
